...
const M22ConferenceTitles = (props) => {
    ...
    */
	...
	const countChampionships = (games) => {
		...
		for (let i = 0; i < games.length; i++) {
			if (games[i].gameType == "championship" && games[i].maddenYear == 2022) {
	...
	return <Card array={arrayOfWinners} Title={"M22 Conference Titles"} />;
};

export default M22ConferenceTitles;
